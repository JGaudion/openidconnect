...
{
    internal class InMemoryIdentityAdminService : IIdentityAdminService
    {
        private ICollection<InMemoryClient> _clients;
        private ICollection<InMemoryScope> _scopes;

        public InMemoryIdentityAdminService(ICollection<InMemoryScope> scopes, ICollection<InMemoryClient> clients)
        {
